    ...
    for root, dirs, files in os.walk(base_dir):
        for file in files:
            if file.endswith('.jpg') or file.endswith('.jpeg'):
                label = file.split('_')[0]  # Modify this depending on file naming convention
...
def main():
    ...
    emotion_question = "Analyze the person's facial expression in the uploaded image. Look closely at the facial features such as the eyebrows, eyes, mouth, and overall facial tension."
