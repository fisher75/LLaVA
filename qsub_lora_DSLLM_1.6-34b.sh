...
deepspeed llava/train/train_mem.py \
    ...
    --model_name_or_path /home/users/ntu/chih0001/scratch/model/llava-v1.6-34b \
    --version v1 \
    ...
    --bf16 True \
    --output_dir /home/users/ntu/chih0001/scratch/model/lora/llava-v1.6-34b-DSLLM-lora \
    --num_train_epochs 1 \
